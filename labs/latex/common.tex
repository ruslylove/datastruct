% Shared preamble for Algorithms and Data Structures lab sheets.
...
\providecommand{\CourseName}{Algorithms and Data Structures}
\providecommand{\CourseCode}{010153523}
\providecommand{\Semester}{Semester 1/2026}
\providecommand{\LabDuration}{2 hours (in-lab)}
...
\newcommand{\takehomebanner}{%
  ...
  \begin{tcolorbox}[
    ...
    Solve the following on paper without using a computer or IDE.
    Hand-write your answers; submit at the start of the next lab.
    Goal: prepare you to trace and reason about code during the written exam.
  \end{tcolorbox}
  \vspace{4pt}
}
